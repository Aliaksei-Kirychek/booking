...
async def test_add_and_get_bookings(
    ...
    user_id = AuthService().decode_token(authenticate_async_client.cookies["access_token"])["user_id"]
    get_resource = await authenticate_async_client.get(
        "/bookings/me",
